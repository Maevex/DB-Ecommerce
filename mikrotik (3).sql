...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 22, 2024 at 01:35 AM
...
INSERT INTO `login` (`login_id`, `customer_id`, `username`, `password`, `role`) VALUES
(4, 4, 'agus', '$2y$10$TvyzDpYcAtE5QlJb5UtUJOBceRCTOrvmOKJkq.jCLJnCgcYZTaET6', 'pelanggan'),
(5, 5, 'arifin', '$2y$10$wEq0cqY2cx1nCwGT/lfpSODFuex3MqSE3v9pk3cwNjiCw/BWajP5i', 'pelanggan');
...
(1, 'gigaroute', 20000.00, 'asdqwdsadsadqwdasdqwdqwdasdasdqweqw', 1, 'images/yy.jpg', 7),
(21, 'alale', 12.00, 'qsdqwdqwd', 1, '2edqds', 91);
...
INSERT INTO `transaction_detail` (`transaction_detail_id`, `transaction_id`, `product_id`, `quantity`, `total_price`) VALUES
(1, 4, 1, 4, 80000.00),
(2, 5, 21, 4, 48.00),
(3, 6, 1, 3, 60000.00),
(4, 7, 1, 3, 60000.00),
...
--
ALTER TABLE `transaction_detail`
  MODIFY `transaction_detail_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
